...
export default function (vm, useCatBlocks) {
    ...
    ScratchBlocks.Blocks.looks_sayforsecs = {
        init: function () {
            this.jsonInit({
                message0: 'say %1 say %2 for %3 seconds',
                args0: [
                    {
                        type: 'field_dropdown',
                        name: 'CUSTOM_LOCATION',
                        options: function () {
                            return [].concat(customMenu());
                        }
                    },
                    {
                        type: 'input_value',
    ...
    ScratchBlocks.Blocks.looks.vm = {
        init: function () {
            this.jsonInit({
                message0: 'vvvv %1 say %2 for %3 seconds',
                args0: [
                    {
                        type: 'field_dropdown',
                        name: 'CUSTOM_LOCATION',
    ...
    // ScratchBlocks.Blocks.motion_moveway.init = function () {
    //     const random = ScratchBlocks.ScratchMsgs.translate('MOTION_MOVE_FORWARD', 'forward');
    //     const mouse = ScratchBlocks.ScratchMsgs.translate('MOTION_MOVE_BACKWARD', 'backward');
    //     const json = jsonForMenuBlock('TO', spriteMenu, motionColors, [
    //         [random, '_forward_'],
    //         [mouse, '_backward_']
    //     ]);
